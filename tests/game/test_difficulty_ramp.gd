...
func test_endpoints_and_midpoint() -> void:
	...
	assert_almost_eq(ramp.cruise_speed(0.0), 12.0, 0.001)
	assert_almost_eq(ramp.cruise_speed(1.0), 30.0, 0.001)
	assert_almost_eq(ramp.cruise_speed(0.5), 21.0, 0.001)
...
func test_progress_is_clamped() -> void:
	...
	assert_almost_eq(ramp.cruise_speed(-1.0), 12.0, 0.001)
	assert_almost_eq(ramp.cruise_speed(2.0), 30.0, 0.001)
